  ...
  return (
    <div className="floating-actions" style={{ position: 'fixed', bottom: '32px', right: '32px', zIndex: 1000, display: 'flex', flexDirection: 'column', gap: '14px', alignItems: 'center' }}>
      ...
      <a 
        ...
        title="Nous appeler"
        style={{ 
          width: '56px', height: '56px', borderRadius: '50%', background: 'var(--primary)', color: 'white', display: 'grid', placeItems: 'center', boxShadow: '0 8px 24px rgba(var(--primary-rgb), 0.3)', transition: 'all 0.3s var(--ease)', textDecoration: 'none' 
        }}
      >
